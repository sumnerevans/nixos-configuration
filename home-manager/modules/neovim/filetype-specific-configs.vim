...
autocmd BufRead *.email,$HOME/tmp/mutt-*,$HOME/tmp/neomutt-*,/etc/nixos/home-manager/modules/email/quotes setlocal tw=72
autocmd BufRead *.email,$HOME/tmp/mutt-*,$HOME/tmp/neomutt-*,/etc/nixos/home-manager/modules/email/quotes setlocal spell spelllang=en_gb
autocmd BufRead *.email,$HOME/tmp/mutt-*,$HOME/tmp/neomutt-*,/etc/nixos/home-manager/modules/email/quotes setlocal colorcolumn=72,80
